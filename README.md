...
## Mock-Up
I need to develop a five day forecast for a specific city.


## Technologies Used
I used CSS and HTML for this project in order to build and style this website. After that, I used JavaScript to upload the city data (longitude and latitude) and the 5 day weather forecast data.
